...
namespace PassaParola
{
    public partial class Form1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (soruno == 1)
            {
                richTextBox1.Text = "arıların kovanlarında kullandıkları geometrik şekil?";
            ...
            if (soruno == 6)
            {
                richTextBox1.Text = "Trabzonda en çok bulunan yemiş türü?";
            ...
            if (soruno == 17)
            {
                richTextBox1.Text = "Çocukların çok sevmediği pirin. havuç gibi sebzelerle yapılan yemek ?";
            ...
            if (soruno == 24)
            {
                richTextBox1.Text = "Ege bölgesinin en çok ağacı bulunan yağıda yapılan kahvaltı besini?";
